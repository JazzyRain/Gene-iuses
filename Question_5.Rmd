...
ggsave(path = "./Question_5_Figures", filename = "5_Distance matrix.pdf" , device = "pdf", width = 20, height = 12 , units = "in" , limitsize = FALSE)##save the plot as pdf
```
...
ggsave(path = "./Question_5_Figures", filename = "5_Dog_Tree.pdf" , device = "pdf", width = 20, height = 12 , units = "in" , limitsize = FALSE)##save the tree as pdf
```
