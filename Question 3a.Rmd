...
COX1Tree<-ggtree(COXTree, layout="rectangular", size=0.002)+geom_tiplab() #generate the phylogenetic tree using ggtree(), arranged in rectangular form with tip labels 
COX1Tree ##call out the tree

ggsave(filename = "COX1 Alignment.pdf" , device = "pdf", width = 40, height = 15 , units = "in" , limitsize = FALSE)##save the tree as pdf
```