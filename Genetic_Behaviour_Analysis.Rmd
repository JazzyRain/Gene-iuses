...
One of the largest effect sizes was found with CFA20 - SNPs in this gene were found to be correlated with the NoiseFear trait. Let's generate an alignment and tree with species that have similar sequences to the Canis lupus familiaris CFA20 gene
## CADPS2 Alignment
```{r}
